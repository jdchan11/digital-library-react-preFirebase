...
export const Library = withRouter(( props:LibraryProps) => {
    const { history } = props;
    ...
    return (
        <div className={`${classes.root} ${classes.column} ${classes.background}`}>
            ...
            <MUIDrawer className={classes.drawer} variant="persistent" anchor="left" open={open} classes={{paper: classes.drawerPaper,}}>
                <div className={`${classes.drawerHeader} ${classes.tableBackground}`}>
            ...
            <main className={`${clsx(classes.content, {[classes.contentShift]: open,})} ${classes.tableLocation}`}>
